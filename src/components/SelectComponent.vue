<template>
  <div id="Select">
    <el-select v-model="selectValue" @change="changeSelect" :placeholder="placeholder" :collapse-tags="collapseTags" :multiple="multiple" :filterable="filterable" :style="`width: ${width}`" :disabled="disabled" :size="size" v-el-select-loadmore="loadmore" :remote-method="remoteMethod" :clearable="clearable">
